...
The intercept is equivalent to mean of the first group. Remaining parameters represent the difference between each group and the first group. 
...
The intercept is equivalent to mean of the last group. Remaining parameters represent the difference between each group and the last group. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the first group. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the last group. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the grand mean. The first group is not compared. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the mean of the subsequent groups. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the mean of the previous groups. 
...
The intercept is equivalent to mean of the first group. Remaining parameters represent the difference between each group and the subsequent group. 
...
The intercept is equivalent to mean of the first group. Remaining parameters represent the difference between each group and the previous group. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the subsequent group. 
...
The intercept is equivalent to mean of the group means. Remaining parameters represent the difference between each group and the previous group. 
